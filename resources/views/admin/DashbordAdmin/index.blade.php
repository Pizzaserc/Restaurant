...
<link href="{{asset('assets/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('assets/admin/admin/css/amara.css')}}" rel="stylesheet" type="text/css" />
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li class="header">You have {{$count+3}} notifications</li>
                            <li>
                                <!-- inner menu: contains the actual data -->
                                <ul class="menu">
                                ...
                                <li >
                                        <a href="#" data-id="">
                                            <i class="fa fa-users text-aqua" ></i>sales made {{$sales}}
                                        </a>
                                    </li>
                                    
                                    <li >
                                        <a href="#" data-id="">
                                            <i class="fa fa-users text-aqua" ></i>numbers order {{$orders}}
                                        </a>
                                    </li>
                                    <li >
                                        <a href="#" data-id="">
                                            <i class="fa fa-users text-aqua" ></i>numbers employee {{$employee}}
                                        </a>
                                    </li>
                                    @foreach( $noready as $notfiy)
                                    <li >
                                        <a href="#" data-id="{{$notfiy->id}}">
                                            <i class="fa fa-users text-aqua" ></i>{{$notfiy->text}} 
                                        </a>
                                    </li>
                                    @endforeach
                                    ...
                                    <li >
                                        <a href="#" data-id="{{$r->id}}">
                                            <i class="fa fa-users text-aqua"></i>{{$r->text}} 
                                        </a>
                                    </li>
                                    @endforeach
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <a  class="btn btn-default btn-flat" href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">logout</a>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="menu" target="-blank"><i class="fa fa-circle-o"></i> Meals</a></li>
                        <li><a href="admin/profit" target="-blank"><i class="fa fa-circle-o"></i> Profit</a></li>
                        <li><a href="menu/element" target="-blank"><i class="fa fa-circle-o"></i> Created of Meals</a></li>
                        <li><a href="menu/chefmenu" target="-blank"><i class="fa fa-circle-o"></i>Chef</a></li>
                    </ul>
                </li>
                <li>
                    <a href="category" target="-blank">
                        <i class="fa fa-th"></i> <span>Category</span> <small class="label pull-right bg-green">new</small>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-edit"></i>
                        <span>Orders && ListWatting</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="chart" target="-blank"><i class="fa fa-circle-o"></i> Morris</a></li>
                        <li><a href="ListWatting" target="-blank"><i class="fa fa-circle-o"></i> ListWatting</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="stock" target="-blank"><i class="fa fa-circle-o"></i> Iteam</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="report" target="-blank"><i class="fa fa-circle-o"></i>reports</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="tables" target="-blank"><i class="fa fa-circle-o"></i>  tables</a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <i class="fa fa-shopping-cart"></i> <span>Deliver</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="parcel" ><i class="fa fa-circle-o"></i> Deliver</a></li>
                ...
                <li class="treeview">
                    <a href="multi">
                        <i class="fa fa-share"></i> <span>MultiUser</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="admin/admins"><i class="fa fa-circle-o"></i>Admins</a></li>
                        <li>
                            <a href="multi"><i class="fa fa-circle-o"></i>User<i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                                <li><a href="multi"><i class="fa fa-circle-o"></i>User</a></li>
                                <li>
                                    <a href="#"><i class="fa fa-circle-o"></i> Shef </a>
                ...
                <li><a href="feedback" target="-blank"><i class="fa fa-map-marker" ></i> Braches</a></li>
                <li><a href="bouns" target="-blank"><i class="fa fa-heart" ></i> Feedback</a></li>
                <li><a href="employee" target="-blank"><i class="fa fa-users"></i> Employee</a></li>
