    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="employee/orders" target="-blank">
                        <i class="fa fa-th"></i> <span>Order </span> <small class="label pull-right bg-green">new</small>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="user"><i class="fa fa-circle-o"></i>User<i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                ...
                <li><a href="admin/feedback" target="-blank"><i class="fa fa-map-marker" ></i> Braches</a></li>
                <li><a href="admin/feedback" target="-blank"><i class="fa fa-heart" ></i> Feedback</a></li>
                <li><a href="admin/employee" target="-blank"><i class="fa fa-users"></i> Employee</a></li>
