...
<link href="{{asset('/admin/plugins/jvectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('/admin/admin/css/amara.css')}}" rel="stylesheet" type="text/css" />
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="feedBackme" target="-blank"><i class="fa fa-map-marker" ></i> Braches</a></li>
                <li><a href="bouns" target="-blank"><i class="fa fa-heart" ></i> Feedback</a></li>
                <li><a href="employees" target="-blank"><i class="fa fa-users"></i> Employee</a></li>
